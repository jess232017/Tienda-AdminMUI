    ...
    return (
        ...
        >
            <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} mb={2}>
                ...
                <Article title="Metodo de pago" link="#" linkText="Ver Metodos" icon={AccountWalletIcon}>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={12} md={4}>
                    <Box
                        sx={{ boxShadow: 1, padding: 2, borderRadius: 2, display: 'none' }}
                        className="box shadow-sm bg-light p-5 d-none pb-4"
                    >
